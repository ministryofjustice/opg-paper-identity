describe("Identify a Certificate Provider", () => {
    it("prevents start on cancelled lpa", () => {
        ...
        cy.contains("ID check has has status: cancelled and cannot be started");
    });
    ...
    it("prevents start on cannot register lpa", () => {
        ...
        cy.contains("ID check has has status: cannot-register and cannot be started");
    });
    ...
    it("prevents start on de-registered lpa", () => {
        ...
        cy.contains("ID check has has status: de-registered and cannot be started");
    });

    it("prevents start on do not register lpa", () => {
    ...
    it("prevents start on expired lpa", () => {
        ...
        cy.contains("ID check has has status: expired and cannot be started");
    });

    it("prevents start on statutory waiting period lpa", () => {
    ...
    it("prevents start on suspended lpa", () => {
        ...
        cy.contains("ID check has has status: suspended and cannot be started");
    });
});
