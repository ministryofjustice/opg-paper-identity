...
class IndexControllerTest extends AbstractHttpControllerTestCase
{
    ...
    {
        $siriusData = ['donor' => ['firstname' => 'Lili', 'surname' => 'Laur', 'dob' => '2019-02-18', 'address' => ['line1' => '17 East Lane', 'line2' => 'Wickerham', 'postcode' => 'W1 3EJ', 'country' => 'GB']]];

        $lpaStoreData = [
            'donor' => ['firstNames' => 'Lilith', 'lastName' => 'Laur', 'dateOfBirth' => '2009-02-18', 'address' => ['line1' => 'Unit 15', 'line2' => 'Uberior House', 'town' => 'Edinburgh', 'postcode' => 'EH1 2EJ', 'country' => 'GB']],
            'certificateProvider' => ['firstNames' => 'x', 'lastName' => 'x', 'address' => ['line1' => '16a Avenida Lucana', 'line2' => 'Cordón', 'country' => 'ES']]
        ];
        ...
        return [
            'draft, donor' => [
                ...
                'donor',
                [
                    'Lili', 'Laur', '2019-02-18', 'donor', ['M-1234-5678-90AB'], ['17 East Lane', 'Wickerham', 'W1 3EJ', 'GB'],
                ]
            ],
            'executed, donor' => [
                [
                ...
                'donor',
                [
                    'Lilith', 'Laur', '2009-02-18', 'donor', ['M-1234-5678-90AB'], ['Unit 15', 'Uberior House', 'Edinburgh', 'EH1 2EJ', 'GB'],
                ]
            ],
            'executed, cp' => [
                [
                ...
                'certificateProvider',
                [
                    'x', 'x', '1000-01-01', 'certificateProvider', ['M-1234-5678-90AB'], ['16a Avenida Lucana', 'Cordón', 'ES'],
                ]
            ],
        ];
    }
    ...
    public function testStartActionFailsForDraftCPs(): void
    {
        ...
        $this->assertStringContainsString('Cannot ID check this certificate provider as the LPA has not yet been submitted', $this->getResponse()->getBody());
    }
    ...
    public function testStartActionFailsWithInvalidType(): void
    {
        ...
        $this->assertResponseStatusCode(400);
        $this->assertStringContainsString('Person type &quot;invalid&quot; is not valid', $this->getResponse()->getBody());
    }
}
