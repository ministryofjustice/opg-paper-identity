...
class LpaHelperTest extends TestCase
{
...
//            ],
    ...
    public function testGetAddressFromSiriusResponse(): void
    {
        ...
        $result = $lpaHelper->getCpAddressFromSiriusResponse($slr);
    ...
    public function testGetNameFromSiriusResponse(): void
    {
        ...
        $result = $lpaHelper->getDonorNameFromSiriusResponse($slr);
    ...
    public function testGetLpaTypeFromSiriusResponse(): void
    {
        ...
        $result = $lpaHelper->getLpaTypeFromSiriusResponse($slr);
    ...
    /**
     * @dataProvider matchLpasData
     */
    public function testLpaIdMatch(string $type, array $lpas, bool $passOrFail): void
    {
        $lpaHelper = new LpaHelper();

        $this->assertEquals($passOrFail, $lpaHelper->lpaIdentitiesMatch($lpas, $type));
    }
