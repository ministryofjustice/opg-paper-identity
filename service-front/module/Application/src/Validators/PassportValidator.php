...
{
    public const PASSPORT_EMPTY = 'passport_empty';
    ...
    protected array $messageTemplates = [
        self::PASSPORT_EMPTY => "Enter the passport number.",
    ...
    public function isValid($value): bool
    {
        ...
        if (empty($this->value)) {
            $this->error(self::PASSPORT_EMPTY);
            return false;
        }
    ...
    {
        return preg_match(self::PASSPORT_PATTERN, $this->value) ?: 0;
    }
